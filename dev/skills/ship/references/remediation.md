...
Only a blocker that survives two rounds on the same root cause is presented as a human call.
...
A re-run of `ship` after the human call starts a fresh budget.
