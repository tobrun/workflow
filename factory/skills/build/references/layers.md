...
Its committed driver produces the `factory.e2e/1` scenario record in [e2e-report.md](e2e-report.md), which the runner re-runs, verifies, and renders to HTML: screenshots for frontend systems, before/after data-model state for everything else.
