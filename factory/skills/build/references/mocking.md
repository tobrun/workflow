...
Test at a higher seam where the collaborator can just run; if the collaborator really is a seam, record it as an `auto-decided:` deviation naming the new seam and test there.
